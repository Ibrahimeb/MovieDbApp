...
class HomePresenter(private var view: HomeContract.View?, private val homeModel: HomeModel) :
    ...
    override fun getZipMovie(currentPage: Int) {
        Log.i(TAG, "getZipMovie: ")
        view?.showProgress(true)
        homeModel.getZipMovie(currentPage)
            .subscribeWith(object : CallbackHandlingObserver<ZipMovie>(this, EndPointTag.ZIPENDPOINT.name) {
    ...
    @SuppressLint("CheckResult")
    override fun getPopular(currentPage: Int) {
        view?.showFooter(true)
        homeModel.getPopular(currentPage).subscribeWith(object :
            CallbackHandlingObserver<ResponseMovie>(this, EndPointTag.MOSTPOPULARENDPOINT.name) {
    ...
    override fun getTopRate(currentPage: Int) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun getUpcoming(currentPage: Int) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
